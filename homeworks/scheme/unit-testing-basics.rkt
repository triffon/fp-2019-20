...
; (може да опишем и свойство, което функцията ни очакваме да изпълнява, така че проверката да стане по-обща и да покрие повече случаи - виж (quickcheck)[https://docs.racket-lang.org/quickcheck/index.html])
