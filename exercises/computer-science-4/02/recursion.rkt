...
; всяка функция си има среда, в която се оценява
; (няколко думи за средите в scheme)

; iter има достъп до аргументите на factorial-iter
...
(time (fib 42))
(time (fib-iter 42))
; Измерва колко време отнема на подадената функция да звърши
