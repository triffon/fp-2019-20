...
(check (sum-digit-divisors 0) => 0)
(check (sum-digit-divisors 1) => 1)
(check (sum-digit-divisors 6) => 6)
(check (sum-digit-divisors 10) => 1)
(check (sum-digit-divisors 42) => 2)
(check (sum-digit-divisors 29) => 0)
(check (sum-digit-divisors 123) => 4)
(check (sum-digit-divisors 1337) => 8)
(check (sum-digit-divisors 222) => 6)
